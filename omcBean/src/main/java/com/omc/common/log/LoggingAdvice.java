...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.omc.*.service.*.*(..)) or "
			+ "execution(* com.omc.*.dao.*.*(..))")
	...
	@After("execution(* com.omc.*.service.*.*(..)) or "
			+ "execution(* com.omc.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.omc.*.service.*.*(..)) or "
			+ "execution(* com.omc.*.dao.*.*(..))")
